...
const TheHeaderDropdownNotif = () => {
  const [itemsNotif, setItemNotif] = useState(0);
  return (
    <CDropdown
      inNav
      className="c-header-nav-item mx-2"
    >
      <CDropdownToggle to="/alertes/alertes-receipt" className="c-header-nav-link" caret={false}>
        <CIcon name="cil-bell"/>
        <CBadge shape="pill" color="danger">{itemsNotif}</CBadge>
      </CDropdownToggle>
